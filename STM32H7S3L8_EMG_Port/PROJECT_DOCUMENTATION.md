...
├── renode_config/         # Emulation configuration
...
# Emulation
make qemu-run               # QEMU emulation
make renode-run             # Renode emulation
make renode-debug           # Renode with debugging
```
...
3. **Emulation Testing**:
   - QEMU: Basic ARM emulation
   - Renode: Full STM32H7S3L8 emulation with virtual ADS1299
...
3. **Emulation**: Test with Renode before hardware
...
- [Renode Emulation](https://renode.readthedocs.io/)
